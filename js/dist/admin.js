...
var setDragImage = function setDragImage(event, draggedElement, customDragImage) {
  ...
  if (event.dataTransfer && event.dataTransfer.setDragImage) {
    ...
    var elementOffset = _offset(draggedElement); // get the dragImage
...
var _destroySortable = function _destroySortable(sortableElement) {
  ...
  _removeContainerEvents(originContainer, previousContainer); // clear sortable flag
...
var _enableSortable = function _enableSortable(sortableElement) {
  ...
  addAttribute(handles, 'draggable', 'true'); // @todo: remove this fix
  // IE FIX for ghost
...
function sortable(sortableElements, options) {
  ...
  sortableElements.forEach(function (sortableElement) {
    ...
    var listItems = _filter(sortableElement.children, options.items); // create element if user defined a placeholder element as a string
    ...
    addAttribute(listItems, 'aria-grabbed', 'false'); // enable hover class
    ...
    */
    ...
    addEventListener(sortableElement, 'drop', function (e) {
      ...
      .filter(isInDom)[0]; // attach element after placeholder

      insertAfter(visiblePlaceholder, dragging); // remove placeholder from dom
    ...
    var debouncedDragOverEnter = _debounce(function (sortableElement, element, pageX, pageY) {
      ...
      if (Array.from(sortableElement.children).indexOf(element) > -1) {
        ...
        var thisIndex = _index(element, element.parentElement.children); // Check if `element` is bigger than the draggable. If it is, we have to define a dead zone to prevent flickering
...
/***/ "./src/admin/components/MasqueradePage.js":
/*!************************************************!*\
  !*** ./src/admin/components/MasqueradePage.js ***!
  \************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return MasqueradePage; });
...
/* harmony import */ var flarum_admin_utils_saveSettings__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! flarum/admin/utils/saveSettings */ "flarum/admin/utils/saveSettings");
/* harmony import */ var flarum_admin_utils_saveSettings__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(flarum_admin_utils_saveSettings__WEBPACK_IMPORTED_MODULE_8__);
...
/* harmony import */ var _SelectFieldOptionEditor__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./SelectFieldOptionEditor */ "./src/admin/components/SelectFieldOptionEditor.js");
...
var MasqueradePage = /*#__PURE__*/function (_ExtensionPage) {
  Object(_babel_runtime_helpers_esm_inheritsLoose__WEBPACK_IMPORTED_MODULE_0__["default"])(MasqueradePage, _ExtensionPage);

  function MasqueradePage() {
    return _ExtensionPage.apply(this, arguments) || this;
  }

  var _proto = MasqueradePage.prototype;
  ...
  _proto.oninit = function oninit(vnode) {
    ...
    this.existing = [];
    this.loadExisting();
    this.enforceProfileCompletion = flarum_admin_app__WEBPACK_IMPORTED_MODULE_2___default.a.data.settings['masquerade.force-profile-completion'] === '1';
  };
  ...
  _proto.content = function content() {
    ...
    return m('.ExtensionPage-settings.ProfileConfigurePane', m('.container', [m('h2', flarum_admin_app__WEBPACK_IMPORTED_MODULE_2___default.a.translator.trans('fof-masquerade.admin.general-options')), m('.Form-group', flarum_common_components_Switch__WEBPACK_IMPORTED_MODULE_6___default.a.component({
      state: this.enforceProfileCompletion,
      onchange: function onchange(value) {
        var saveValue = value ? '1' : '0';
        flarum_admin_utils_saveSettings__WEBPACK_IMPORTED_MODULE_8___default()({
          'masquerade.force-profile-completion': saveValue
        });
        _this2.enforceProfileCompletion = saveValue;
      }
    }, flarum_admin_app__WEBPACK_IMPORTED_MODULE_2___default.a.translator.trans('fof-masquerade.admin.fields.force-user-to-completion'))), m('h2', flarum_admin_app__WEBPACK_IMPORTED_MODULE_2___default.a.translator.trans('fof-masquerade.admin.fields.title')), m('form.js-sortable-fields', this.existing.map(function (field) {
  ...
  _proto.addField = function addField(field) {
    ...
    return m('fieldset.Field', {
      'data-id': field.id(),
      key: field.id()
    }, [m('legend', [exists ? [flarum_common_components_Button__WEBPACK_IMPORTED_MODULE_7___default.a.component({
    ...
    }, [flarum_admin_app__WEBPACK_IMPORTED_MODULE_2___default.a.translator.trans('fof-masquerade.admin.fields.' + (exists ? 'edit' : 'add'), {
      field: field.name()
    }), ' ', flarum_common_helpers_icon__WEBPACK_IMPORTED_MODULE_3___default()('fas fa-caret-down')])]), m('.Field-body', [m('.Form-group', [m('label', flarum_admin_app__WEBPACK_IMPORTED_MODULE_2___default.a.translator.trans('fof-masquerade.admin.fields.name')), m('input.FormControl', {
      value: field.name(),
      oninput: flarum_common_utils_withAttr__WEBPACK_IMPORTED_MODULE_9___default()('value', this.updateExistingFieldInput.bind(this, 'name', field))
    }), m('span.helpText', flarum_admin_app__WEBPACK_IMPORTED_MODULE_2___default.a.translator.trans('fof-masquerade.admin.fields.name-help'))]), m('.Form-group', [m('label', flarum_admin_app__WEBPACK_IMPORTED_MODULE_2___default.a.translator.trans('fof-masquerade.admin.fields.description')), m('input.FormControl', {
      value: field.description(),
      oninput: flarum_common_utils_withAttr__WEBPACK_IMPORTED_MODULE_9___default()('value', this.updateExistingFieldInput.bind(this, 'description', field))
    }), m('span.helpText', flarum_admin_app__WEBPACK_IMPORTED_MODULE_2___default.a.translator.trans('fof-masquerade.admin.fields.description-help'))]), m('.Form-group', [m('label', flarum_admin_app__WEBPACK_IMPORTED_MODULE_2___default.a.translator.trans('fof-masquerade.admin.fields.icon')), m('input.FormControl', {
      value: field.icon(),
      oninput: flarum_common_utils_withAttr__WEBPACK_IMPORTED_MODULE_9___default()('value', this.updateExistingFieldInput.bind(this, 'icon', field))
    }), m('span.helpText', flarum_admin_app__WEBPACK_IMPORTED_MODULE_2___default.a.translator.trans('fof-masquerade.admin.fields.icon-help', {
      a: m("a", {
        href: "https://fontawesome.com/icons?m=free",
        target: "_blank"
      })
    }))]), m('.Form-group', flarum_common_components_Switch__WEBPACK_IMPORTED_MODULE_6___default.a.component({
      state: field.on_bio(),
      onchange: this.updateExistingFieldInput.bind(this, 'on_bio', field)
    }, flarum_admin_app__WEBPACK_IMPORTED_MODULE_2___default.a.translator.trans('fof-masquerade.admin.fields.on_bio'))), m('.Form-group', flarum_common_components_Switch__WEBPACK_IMPORTED_MODULE_6___default.a.component({
      state: field.required(),
      onchange: this.updateExistingFieldInput.bind(this, 'required', field)
    }, flarum_admin_app__WEBPACK_IMPORTED_MODULE_2___default.a.translator.trans('fof-masquerade.admin.fields.required'))), m('.Form-group', [m('label', flarum_admin_app__WEBPACK_IMPORTED_MODULE_2___default.a.translator.trans('fof-masquerade.admin.fields.type')), flarum_common_components_Select__WEBPACK_IMPORTED_MODULE_5___default.a.component({
      onchange: function onchange(value) {
        if (value === 'null') {
          value = null;
        }
      ...
      value: field.type()
    })]), field.type() === 'select' ? _SelectFieldOptionEditor__WEBPACK_IMPORTED_MODULE_10__["default"].component({
      onchange: function onchange(value) {
        _this3.updateExistingFieldInput('validation', field, value);
      },
      value: field.validation()
    }) : null, field.type() === null ? m('.Form-group', [m('label', flarum_admin_app__WEBPACK_IMPORTED_MODULE_2___default.a.translator.trans('fof-masquerade.admin.fields.validation')), m('input.FormControl', {
      value: field.validation(),
      oninput: flarum_common_utils_withAttr__WEBPACK_IMPORTED_MODULE_9___default()('value', this.updateExistingFieldInput.bind(this, 'validation', field))
    }), m('span.helpText', flarum_admin_app__WEBPACK_IMPORTED_MODULE_2___default.a.translator.trans('fof-masquerade.admin.fields.validation-help', {
      a: m("a", {
        href: "https://laravel.com/docs/5.2/validation#available-validation-rules",
        target: "_blank"
      })
    }))]) : null, m('.Form-group', m('.ButtonGroup', [flarum_common_components_Button__WEBPACK_IMPORTED_MODULE_7___default.a.component({
    ...
    }, flarum_admin_app__WEBPACK_IMPORTED_MODULE_2___default.a.translator.trans('fof-masquerade.admin.buttons.' + (exists ? 'edit' : 'add') + '-field')), exists ? flarum_common_components_Button__WEBPACK_IMPORTED_MODULE_7___default.a.component({
      className: 'Button Button--danger',
      loading: this.loading,
      onclick: this.deleteField.bind(this, field)
    }, flarum_admin_app__WEBPACK_IMPORTED_MODULE_2___default.a.translator.trans('fof-masquerade.admin.buttons.delete-field')) : null]))])]);
  };
  ...
  _proto.updateSort = function updateSort(sorting) {
    flarum_admin_app__WEBPACK_IMPORTED_MODULE_2___default.a.request({
      method: 'POST',
      url: flarum_admin_app__WEBPACK_IMPORTED_MODULE_2___default.a.forum.attribute('apiUrl') + '/masquerade/fields/order',
      body: {
        sort: sorting
      }
  ...
  _proto.submitAddField = function submitAddField(e) {
    ...
    e.preventDefault();
    this["new"].save(this["new"].data.attributes).then(this.requestSuccess.bind(this)).then(function () {
      _this4.resetNew();
    });
    m.redraw();
  }
  ...
  _proto.requestSuccess = function requestSuccess() {
    this.existing = flarum_admin_app__WEBPACK_IMPORTED_MODULE_2___default.a.store.all('masquerade-field'); // Update order in case the store order doesn't reflect the true ordering
  ...
  _proto.loadExisting = function loadExisting() {
    ...
    this.loading = true;
    return flarum_admin_app__WEBPACK_IMPORTED_MODULE_2___default.a.request({
      method: 'GET',
      url: flarum_admin_app__WEBPACK_IMPORTED_MODULE_2___default.a.forum.attribute('apiUrl') + '/masquerade/fields'
    }).then(function (result) {
      flarum_admin_app__WEBPACK_IMPORTED_MODULE_2___default.a.store.pushPayload(result);

      _this5.requestSuccess();
    });
  }
  /**
  ...
  _proto.resetNew = function resetNew() {
    this["new"] = flarum_admin_app__WEBPACK_IMPORTED_MODULE_2___default.a.store.createRecord('masquerade-field', {
      attributes: {
        name: '',
        description: '',
        prefix: '',
  ...
  _proto.availableTypes = function availableTypes() {
    return {
      url: flarum_admin_app__WEBPACK_IMPORTED_MODULE_2___default.a.translator.trans('fof-masquerade.admin.types.url'),
      email: flarum_admin_app__WEBPACK_IMPORTED_MODULE_2___default.a.translator.trans('fof-masquerade.admin.types.email'),
      "boolean": flarum_admin_app__WEBPACK_IMPORTED_MODULE_2___default.a.translator.trans('fof-masquerade.admin.types.boolean'),
      select: flarum_admin_app__WEBPACK_IMPORTED_MODULE_2___default.a.translator.trans('fof-masquerade.admin.types.select'),
      "null": flarum_admin_app__WEBPACK_IMPORTED_MODULE_2___default.a.translator.trans('fof-masquerade.admin.types.advanced')
    };
  };

  return MasqueradePage;
...
var SelectFieldOptionEditor = /*#__PURE__*/function (_Component) {
  ...
  _proto.view = function view() {
    ...
    return m('.Form-group', [m('label', flarum_admin_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('fof-masquerade.admin.fields.options')), m('table', m('tbody', this.options().map(function (option, optionIndex) {
      return m('tr', [m('td', m('input[type=text].FormControl', {
        oninput: function oninput(event) {
          _this.updateOption(optionIndex, event.target.value);
        },
        value: option
      ...
      }, flarum_common_helpers_icon__WEBPACK_IMPORTED_MODULE_3___default()('fas fa-chevron-up'))), m('td', m('button.Button', {
        onclick: function onclick() {
          _this.moveOption(optionIndex, 1);
        }
      }, flarum_common_helpers_icon__WEBPACK_IMPORTED_MODULE_3___default()('fas fa-chevron-down'))), m('td', m('button.Button.Button--danger', {
        onclick: function onclick() {
          _this.deleteOption(optionIndex);
        }
      }, flarum_common_helpers_icon__WEBPACK_IMPORTED_MODULE_3___default()('fas fa-times')))]);
    }))), m('.helpText', flarum_admin_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('fof-masquerade.admin.fields.option-comma-warning')), m('table', m('tbody'), m('tr', [m('td', m('input[type=text].FormControl', {
      onchange: function onchange(event) {
        _this.newOption = event.target.value;
      },
      value: this.newOption,
      placeholder: flarum_admin_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('fof-masquerade.admin.fields.option-new')
    })), m('td', m('button.Button.Button--primary', {
      onclick: function onclick() {
        _this.addOption();
      }
    }, flarum_common_helpers_icon__WEBPACK_IMPORTED_MODULE_3___default()('fas fa-plus')))]))]);
  };
  ...
  _proto.options = function options() {
    var rules = this.attrs.value.split('|');
    var options = [];
...
/* harmony import */ var _lib_models_Field__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./../lib/models/Field */ "./src/lib/models/Field.js");
/* harmony import */ var _components_MasqueradePage__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/MasqueradePage */ "./src/admin/components/MasqueradePage.js");



flarum_admin_app__WEBPACK_IMPORTED_MODULE_0___default.a.initializers.add('fof-masquerade', function () {
  flarum_admin_app__WEBPACK_IMPORTED_MODULE_0___default.a.store.models['masquerade-field'] = _lib_models_Field__WEBPACK_IMPORTED_MODULE_1__["default"];
  flarum_admin_app__WEBPACK_IMPORTED_MODULE_0___default.a.extensionData["for"]('fof-masquerade').registerPage(_components_MasqueradePage__WEBPACK_IMPORTED_MODULE_2__["default"]).registerPermission({
    icon: 'far fa-id-card',
    label: flarum_admin_app__WEBPACK_IMPORTED_MODULE_0___default.a.translator.trans('fof-masquerade.admin.permissions.view-profile'),
    permission: 'fof.masquerade.view-profile',
    allowGuest: true
  }, 'view').registerPermission({
    icon: 'far fa-id-card',
    label: flarum_admin_app__WEBPACK_IMPORTED_MODULE_0___default.a.translator.trans('fof-masquerade.admin.permissions.have-profile'),
    permission: 'fof.masquerade.have-profile'
  }, 'start').registerPermission({
    icon: 'far fa-id-card',
    label: flarum_admin_app__WEBPACK_IMPORTED_MODULE_0___default.a.translator.trans('fof-masquerade.admin.permissions.edit-others-profile'),
